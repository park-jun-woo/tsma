...
//ff:what Resolves a bare Python function call by same-directory then name matching
package graph

import "github.com/park-jun-woo/tsma/internal/model"

// resolvePyBareCall resolves a bare function call.
func resolvePyBareCall(funcName string, callerIdx int, callerFile string, functions []model.Function, idx *funcIndex) {
