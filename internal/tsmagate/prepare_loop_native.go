...
func prepareLoopNative(it *quest.Item, p funcPayload, raw []byte) (*measurement, bool) {
	...
	case "rust":
		return prepareLoopRs(it, p, raw), true
	}
	return nil, false
}
