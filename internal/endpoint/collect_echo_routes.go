...
//ff:what Walks project Go files to collect Echo route registrations
package endpoint
...
func collectEchoRoutes(projectRoot string) ([]routeRegistration, error) {
	...
	err := filepath.Walk(projectRoot, func(path string, info os.FileInfo, err error) error {
		...
		found, parseErr := parseFileForEchoRoutes(path, projectRoot)
		if parseErr != nil {
			return nil
		}
