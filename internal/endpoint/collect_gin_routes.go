...
//ff:what Walks project Go files to collect Gin route registrations
package endpoint
...
func collectGinRoutes(projectRoot string) ([]routeRegistration, error) {
	...
	err := filepath.Walk(projectRoot, func(path string, info os.FileInfo, err error) error {
		...
		found, parseErr := parseFileForRoutes(path, projectRoot)
		if parseErr != nil {
			return nil
		}
